---
title: "EDS Job Market Report: Winter"
author: "Sofia Sarak"
date: March 29, 2026
format: html
editor: visual
...
This specific report builds off of its predecessor, which was based on job posts solely from the Fall Quarter (collected from October 2025 to January 2026).
...
ggplot(aes(x = reorder(sector, count), y = count,
  ...
  report_theme +
  coord_flip() +
  scale_color_manual(values = c(bren_blue, bren_green)) +
  scale_fill_manual(values = c(bren_blue, bren_green))
```
