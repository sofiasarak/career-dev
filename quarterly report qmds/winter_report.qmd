...
all_clean <- all_clean %>% 
  mutate(R_req = stringr::str_detect(all_clean$hard_skills, "R"), 
         ...
         spatial_req = stringr::str_detect(all_clean$hard_skills, "Spatial analysis"),
         remote_req = stringr::str_detect((all_clean$hard_skills, "remote")))

# Create data frame with the number of positions that mentioned each skill
skills <- c("R", "Python", "GIS", "Excel", "SQL", "Power BI", "Spatial analysis")
